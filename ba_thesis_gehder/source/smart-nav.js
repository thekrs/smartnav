(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("smart-nav", [], factory);
	else if(typeof exports === 'object')
		exports["smart-nav"] = factory();
	else
		root["smart-nav"] = factory();
})(this, function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var eleGen = __webpack_require__(2);
	var initTouch;
	var navigation = [{
	    title: 'Mobilfunk',
	...
	$(document).ready(function () {
	    ...
	    body.addEventListener('touchstart', function (eStart) {
	        ...
	        var bottomRow = bottomRowPixel < initTouch.clientY;
	        if (bottomRow) {
	            var canvasRight = window.screen.width / 2 < initTouch.clientX;
...
/***/ function(module, exports) {
	...
	function createCanvas(links, right) {
	    rootNav = links;
	    if (localNav) canvasLinks = localNav;else canvasLinks = rootNav;
	    initPosX = undefined;
	    initPosY = undefined;
	    ...
	    $(canvas).attr('width', '300px').attr('height', '300px').css({
	        position: 'fixed',
	        top: 'calc(100% - 100px)',
	        left: 'calc(' + posLeft + ')',
	        opacity: '0.1',
	...
	function touchEndCanvas(e) {
	    ...
	    if (!canvasRotated) clickLink(e);else console.log("*****");
	    console.log("end");
	}
	/**
	 * 
...
;
//# sourceMappingURL=smart-nav.js.map